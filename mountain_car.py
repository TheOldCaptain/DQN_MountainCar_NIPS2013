...
class car_DQN:
    ...
    def network_loss_function(self):
        ...
        print("abc:", self.network_out.eval)
    ...
    def train_network(self):
        ...
        # NIPS 2013版本的DQN对y值（这里是y_batch）的定义，算法的精髓（essence）
        y_batch = []
        q_value_batch = self.network_out.eval(feed_dict={self.state_input: next_state_batch})
    ...
    def choose_action(self, state):
        net_out_value = self.network_out.eval(feed_dict={self.state_input: [state]})[0]
